...
initGS <- function() {
  ...
  initconf <- "$(function () { $('.grid-stack').gridstack({ float:false, width: 12, cellHeight: 80, verticalMargin: 10}); });"
